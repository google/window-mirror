/// <copyright file="UIWithSuperSample.shader" company="Google LLC">
//
...
Shader "UI/SuperSample"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 tex2DRotated(sampler2D tex, float2 uv)
            {
                float2 dx = ddx(uv);
                float2 dy = ddy(uv);
                ...
                half4 col = 0;
                col += tex2Dbias(_MainTex, float4(uv, 0, 0));
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                half4 color = (tex2DRotated(_MainTex, IN.texcoord) + _TextureSampleAdd) * IN.color;
